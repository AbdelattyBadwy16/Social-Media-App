...
export default function LeftNavbar() {
    ...
    return (
        <div className={`leftNavBar ${!Active ? 'w-[5%]' : 'w-[10%]'} bg-[white] h-[100vh] shadow-lg transition-all z-[1000] flex flex-col items-center fixed`}>
            ...
            <Link className='flex mt-[160px] gap-3'>
